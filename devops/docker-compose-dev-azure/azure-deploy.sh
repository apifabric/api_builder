...
resourcename="apibuilder"  # lower case, only
resourcegroup="apibuilder_rg"
...
# git clone https://github.com/apilogicserver/apibuilder.git
# cd apibuilder
...
az group create --name apibuilder_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group apibuilder_rg --sku S1 --is-linux
az container create --resource-group apibuilder_rg --name apibuilder --image apilogicserver/apibuilder:latest --dns-name-label apibuilder --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//apibuilder.westus.azurecontainer.io:5656'
